...
class custom_VAE(LightningModule):
    ...
    def pretrained_weights_available():
        return list(custom_VAE.pretrained_urls.keys())

    def from_pretrained(self, checkpoint_name):
        if checkpoint_name not in custom_VAE.pretrained_urls:
...
def cli_main(args=None):
    ...
    parser = custom_VAE.add_model_specific_args(parser)
